  ...
  return (
    <section>
      <div className="relative w-full h-[60vh] bg-self-blue">
        ...
        <div className="w-full absolute flex items-center justify-center top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-4xl font-bold tracking-wider text-white">
          <h1 className="line-clamp-2">{text}</h1>
        </div>
      </div>
    </section>
  );
